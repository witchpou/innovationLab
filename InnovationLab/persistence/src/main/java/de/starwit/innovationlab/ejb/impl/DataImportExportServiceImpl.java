...
import de.starwit.innovationlab.config.ProjectConfig;
import de.starwit.innovationlab.ejb.DataImportExportService;
		...
		try {
			...
			if (file.exists()) {
			    ...
			    while (tok.hasMoreTokens()) {
					...
					Class<? extends AbstractEntity> entityClass = (Class<? extends AbstractEntity>) Class.forName("de.starwit.innovationlab.entity." + entityName);
